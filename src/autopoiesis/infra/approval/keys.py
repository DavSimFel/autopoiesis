...
from autopoiesis.infra.approval.crypto import (
    compute_key_id,
    decrypt_private_key,
    encrypt_private_key,
...
from autopoiesis.infra.approval.key_files import (
    KeyringEntry,
    read_json_file,
    resolve_path,
...
from autopoiesis.infra.approval.types import SIGNED_OBJECT_CONTEXT, SignedDecision
...
class ApprovalKeyManager:
    ...
    def ensure_unlocked_interactive(self) -> None:
        ...
        # APPROVAL_KEY_PASSPHRASE enables headless/Docker usage.
        # Security note: env vars are visible in /proc on Linux.
        passphrase = os.environ.get("APPROVAL_KEY_PASSPHRASE") or getpass.getpass(
            "Approval signing key passphrase: "
        )
